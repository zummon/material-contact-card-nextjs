		...
		<ThemeProvider>
			<html className={dark ? 'dark' : ''}>
				<head>
					...
					<link href={translates[lang].fontFamilySrc} rel="stylesheet" />
				</head>
				<body className="bg-gray-50 dark:bg-gray-900 dark:text-gray-50" style={{fontFamily: translates[lang].fontFamily}}>
					<div className="max-w-5xl mx-auto flex justify-between gap-4 p-4">
						<div className="">
							<div className="">
								<Link href="/">
									<Typography variant="h3" className="font-medium">
										{translates[lang]['headline']}
									</Typography>
								</Link>
							</div>
							<div className="">
								<a href="https://zummon.page/" target="_blank">
									<Button className="normal-case text-base font-normal text-inherit" variant="text">
										{translates[lang]['sub-headline']}
									</Button>
								</a>
							</div>
						</div>
							...
							<div className="">
								<label className="" htmlFor="set-dark-mode">
									<Typography className="font-medium inline-block">
										{translates[lang]['toggle-dark-mode']}
									</Typography>
								</label>
								...
								<div className="">
									<Menu open={openLang} handler={setOpenLang}>
										<MenuHandler>
											...
											>
												<span className="">
													{translates[lang]['change-language']}
												</span>
												<span className="">
													{translates[lang]['name']}
												</span>
						...
						<Tabs className="bg-white dark:bg-gray-800 border rounded dark:border-gray-700" value={activeTab}>
							...
							>
								<Tab
									...
									className={`py-4 text-inherit ${activeTab === 'about' ? "" : ""}`}
								>
									{translates[lang]['about']}
								</Tab>
								<Tab
									value="goal"
									onClick={() => setActiveTab('goal')}
									className={`py-4 text-inherit ${activeTab === 'goal' ? "" : ""}`}
								>
									{translates[lang]['goal']}
								</Tab>
								<Tab
									value="contact"
									onClick={() => setActiveTab('contact')}
									className={`py-4 text-inherit ${activeTab === 'contact' ? "" : ""}`}
								>
									{translates[lang]['contact']}
								</Tab>
							</TabsHeader>
							<TabsBody className="">
								<TabPanel className="text-inherit" value="about">
									...
									<p className="">
										{translates[lang]['about-detail']}
									</p>
								</TabPanel>
								<TabPanel className="text-inherit" value="goal">
									<p className="">
										{translates[lang]['goal-detail']}
									</p>
								</TabPanel>
								<TabPanel className="text-inherit" value="contact">
									...
									<p className="">
										{translates[lang]['contact-detail']}
									</p>
								</TabPanel>
							</TabsBody>
						</Tabs>
